...
class JConfig {
	...
	public $sitename = 'ihlsociety.org';				// Name of Joomla site
	...
	public $host = 'ihl1329008235287.db.11861457.hostedresource.com';					// This is normally set to localhost
	public $user = 'ihl1329008235287';							// DB username
	public $password = 'm4W#lS2134D';						// DB password
	public $db = 'ihl1329008235287';							// DB database name
	public $dbprefix = 'jos_';					// Do not change unless you need to!

	/* Server Settings */
	public $secret = 'f6740828369e716d3a3ce5819e067b07'; 		// Change this to something more secure
	public $gzip = '0';
	...
	/* Mail Settings */
	public $mailer = 'smtp';
	public $mailfrom = 'csjfong@cityu.edu.hk';
	public $fromname = 'ihlsociety.org';
